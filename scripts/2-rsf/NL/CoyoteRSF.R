...
samplePts <- rbindlist(list(regPts, coyote), 
...
lapply(
  ...
  FUN = function(r) {
    writeRaster(
      rsfs[[r]],
      paste0('output/2-rsf/coyote/coyotersf', names(rsfs[r])),
      format = 'GTiff',
      overwrite = T
    )
  }
...
# Regular points
saveRDS(regPts, 'output/2-rsf/coyote/coyoteRegularPoints.Rds')
