...
RSFCaribouWin<-glm(use~Con+Lic+Mix+Roc+Scr+WaD+Lin+Rug,data=CarWinterRSF, family='binomial')
...
WinRSF<-exp(coef(RSFCaribouWin)[1]+ConR*coef(RSFCaribouWin)[2]+LicR*coef(RSFCaribouWin)[3]+
              MixR*coef(RSFCaribouWin)[4]+RocR*coef(RSFCaribouWin)[5]+ScrR*coef(RSFCaribouWin)[6]+WaDR*coef(RSFCaribouWin)[7]+
